...
module.exports = (sequelize, DataTypes) => {
  class User extends Model {
    ...
    static associate(models) {
      ...
      this.hasMany(models.PurchasingData, {foreignKey: "UserId", sourceKey: "id"})
      this.hasMany(models.Checkout, {foreignKey: "UserId", sourceKey: "id"})
      this.hasMany(models.Cart, {foreignKey: "UserId", sourceKey: "id"})
      this.hasMany(models.Wishlist, {foreignKey: "UserId", sourceKey: "id"})
    }
  };
  User.init({
    name: {
